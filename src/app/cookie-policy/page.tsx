          ...
          <div className="space-y-8 text-gray-700">
            <section>
              ...
              <p className="mb-4">
                ...
                information to website owners. Cookies can be "persistent" or "session" cookies.
              ...
              <div className="space-y-6">
                ...
                <div className="border-l-4 border-green-600 pl-4">
                  ...
                  <div className="bg-gray-50 p-4 rounded-lg">
                    ...
                    <p className="text-sm mb-2">
                      Microsoft Clarity is a user behavior analytics tool that helps us understand
                      how users interact with our website through session recordings and heatmaps.
                    </p>
                    <table className="w-full text-sm">
                      <thead>
                        <tr className="border-b">
                ...
                <div className="border-l-4 border-purple-600 pl-4">
                  ...
                  <p className="mb-4">
                    ...
                    display ads that are relevant and engaging for users and thereby more valuable
