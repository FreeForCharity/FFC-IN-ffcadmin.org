...
export const metadata: Metadata = {
  ...
  description:
    'A complete project guide for migrating membership records into Zeffy CRM using Claude AI & Cowork Mode. Covers data assessment, cleanup, import file generation, and verification.',
  keywords:
    'Zeffy, CRM, data migration, membership data, Claude AI, Cowork Mode, nonprofit, CSV import',
}
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-gradient-to-r from-violet-600 to-purple-600 text-white py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto">
          ...
          <h1 className="text-4xl sm:text-5xl font-bold mb-4">Member Data Migration to Zeffy</h1>
          <p className="text-xl text-violet-100 mb-6">
            A Complete Project Guide Using Claude AI &amp; Cowork Mode
          </p>
