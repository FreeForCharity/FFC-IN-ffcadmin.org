# Gemini Instructions: FFC-IN-ffcadmin.org
...
The site deploys to `https://freeforcharity.github.io/FFC-IN-ffcadmin.org/` (and your custom domain if configured). The `assetPath()` function from `src/lib/assetPath.ts` handles this automatically.
